(function() {
    ...
    function WeatherService($http) {
        //console.log("##### Call WeatherService");
        ...
        service.init = function(geoposition) {
            console.log("WeatherService geoposition.coords.latitude : " + geoposition.coords.latitude + ", geoposition.coords.longitude : " + geoposition.coords.longitude);

	    // SOOK== 20160914, add the lang value in request 
    	    // + "&lang=" + language 
	    //var language = "en";
	    ...
	    //var language = "en";
            return $http.jsonp('https://api.forecast.io/forecast/'+config.forecast.key+'/'+
                ...
                .then(function(response) {
                    console.log("#### CAll WeatherService response: " + response);
        ...
        service.currentForcast = function() {
            console.log("#### CAll WeatherService currentForcast: ");
        ...
        service.weeklyForcast = function(){
            ...
            for (var i = 0; i < service.forcast.data.daily.data.length; i++) {
                ...
                if(day == "Mon") service.forcast.data.daily.data[i].day = "MON";
                else if(day == "Tue") service.forcast.data.daily.data[i].day = "TUE";
                else if(day == "Wed") service.forcast.data.daily.data[i].day = "WED";
                else if(day == "Thu") service.forcast.data.daily.data[i].day = "THU";
                else if(day == "Fri") service.forcast.data.daily.data[i].day = "FRI";
                else if(day == "Sat") service.forcast.data.daily.data[i].day = "SAT";
                else if(day == "Sun") service.forcast.data.daily.data[i].day = "SUN";*/
